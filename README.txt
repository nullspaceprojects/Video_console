...
== ITALIAN VERSION ==
Puo' succedere che il dispositivo venga riconosciuto da windows ma non sia funzionante.
...
== ENG VERSION ==
It could happen that the keyboard is recognized by Windows but it does not work.
Go to Control Panel -> Hardware and Sound -> Device and Printers -> Select the keyboard icon called PICO -> right click -> properties
-> Click on the Hardware Tab -> Click on USB MASS STORAGE DEVICE -> properties -> 
-> Click on General Tab -> Click Change Settings -> Click on Tab Driver -> Click Disable Device.
Happy Video Editing with our board :)

The NullSpaceProjects Team
